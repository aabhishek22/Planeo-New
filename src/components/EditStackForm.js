            ...
            {activeTab === "Template" && (
              <div className=" relative">
                <textarea
                  ...
                  className="bg-gray-800  max-h-40 w-full border-none resize-none overflow-y-auto   focus:outline-none focus:ring-0 "
                  rows={5}
                />
                <button
                  type="button"
                  onClick={() => handleSaveYaml()}
                  className="absolute bottom-3 right-6 bg-blue-500 text-white text-xs py-1 px-3 rounded hover:bg-blue-600 transition-colors"
                >
                  Save
                </button>
              </div>
            ...
            {activeTab === "Arguments" && (
              <div className="text-sm">
                <div className="grid grid-cols-3 mb-2">
                  ...
                  <div className="text-gray-300 pl-5">Value</div>
